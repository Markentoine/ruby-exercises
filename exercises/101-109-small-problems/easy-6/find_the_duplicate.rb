...
# => manipulate array so that its possible to find a duplicate

# input: some array
# output: some object, that was duplicated in the array.
...
# describe algorithm
def find_dup(some_array)
  some_array.sort
  some_array.each { |elem| return elem if some_array[elem] == some_array[elem +1]}
end
